...
`, BuildDate, BuildNumber, LatestCommit, RuntimeVer, BuiltOnOs)
	...
	db, err := gorm.Open("mysql", "doadmin:AVNS_nQrjtn8ilVHqYs6xIim@tcp(dbaas-db-7154856-do-user-13260059-0.b.db.ondigitalocean.com:25060)/shoes_development?parseTime=true")
	if err != nil {
